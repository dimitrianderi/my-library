<template>
      <div class="book">
        ...
        <div class="book__info">
            ...
            <span class="book__text">автор: <span class="book__desc">{{ request.author }}</span></span>
            <span class="book__text">жанр: <span class="book__desc">{{ genres(request.genre) }}</span></span>
            <span class="book__text">страниц: <span class="book__desc">{{ request.pages }}</span></span>
            <span class="book__text line">обложка: <span class="book__desc">{{ covers(request.cover) }}</span></span>
            <hr class="hr">
